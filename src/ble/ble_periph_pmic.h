...
#define ADCCH0_RD_MV_CHARACTERISTIC_UUID BT_UUID_128_ENCODE(0xADC0012D, 0x2EAD, 0x4008, 0xb432, 0xb46096c049ba)
#define ADCCH1_RD_MV_CHARACTERISTIC_UUID BT_UUID_128_ENCODE(0xADC0112D, 0x2EAD, 0x4faf, 0x956b, 0xafb01c17d0be)
#define LSLDO_WR_MV_CHARACTERISTIC_UUID BT_UUID_128_ENCODE(0x757D0111, 0x217E, 0x4faf, 0x956b, 0xafb01c17d0be)
